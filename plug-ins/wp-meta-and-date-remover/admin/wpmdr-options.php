        ...
        <div class="card" style="max-width:100%;height:1000px">
				...
				<form method="post" action="<?php echo $action_url;?>">
					...
					<?php echo wp_nonce_field('acc_nonce_wpmdr','acc_nonce_field_wpmdr') ?>
						...
						<p><blockquote style="font-size:18px">We are planning to release new product for you. <a href="https://linkto.run/p/EGD08PBV" target="_blank"><b>Help us to give you great product</b></a></blockquote>
						</p>
						<br/>
						<p>
		...
		<div class="col  m3">
			<div class="card">
				<div class="card-content">
					...
					<br/><br/>
					<a target="_blank" href="https://mythemeshop.com/themes/?ref=prasadkirpekar&campaign=Themes" class="btn purple pulse side-btn">Themes</a>
					<br/><br/>
